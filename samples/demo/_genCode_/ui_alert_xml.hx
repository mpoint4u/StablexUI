...
__ui__widget3.addEventListener(flash.events.MouseEvent.CLICK, function(event:flash.events.MouseEvent){cast(event.currentTarget, ru.stablex.ui.widgets.Button).getParent('popup').free();});
__ui__widget3._onInitialize();
__ui__widget3._onCreate();
__ui__widget2.addChild(__ui__widget3);
